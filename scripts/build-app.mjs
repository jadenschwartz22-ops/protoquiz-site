        ...
        <div class="shot-col">
          <div class="toggles">
            ...
            <div class="toggle" role="group" aria-label="Theme">
              <button type="button" data-set="shift:night" aria-pressed="true"><span class="dot dot-night"></span><span>Night</span></button>
              <button type="button" data-set="shift:day" aria-pressed="false"><span class="dot dot-day"></span><span>Day</span></button>
            </div>
          </div>
